...
class CourseInterfaceService extends SoapService
{
     ...
     * @throws Exception
     */
    public function readPersonExamPlanEnrollmentsForUnit($plan_element, $unit_id, $term_type_id, $year, $work_status_ids = [1,6,8,29], $cancellation = null, $updated_since = null)
    {
        //Todo: rework!
        $params = array(array('unitId' => $unit_id, 'termTypeId' => $term_type_id, 'year' => $year, 'workstatusIds' => [1,6,8,29], 'cancellation' => $cancellation, 'updatedSince' => $updated_since));
        try {
